        ...
        <div className="max-w-md w-full">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-muted text-xl sm:text-2xl">
              Join us and start tracking your coding interviews
            </p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <label className="ml-3 text-white text-lg">
                  I agree to the{' '}
                  <Link href="/terms" className="text-primary hover:text-primary/80 text-lg">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-primary hover:text-primary/80 text-lg">
                    Privacy Policy
                  </Link>
                </label>
              </div>
